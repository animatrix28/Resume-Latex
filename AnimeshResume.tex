...
\begin{tabularx}{\textwidth}{@{}Xr@{}}
    \textbf{Software Developer Engineer Intern, Redvest} & May 2024 – October 2024 | Los Angeles, USA \\
\end{tabularx}
\vspace{-5mm}
...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Built a \textbf{React}-based analytics dashboard to visualize real-time financial metrics, improving operational efficiency for cross-functional teams.
...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Led the deployment of \textbf{Firebase} Authentication \textbf{API} and integrated Google Sign-In for the Flipping app, which increased account access speeds by 60\%.
    \end{highlights}
\end{onecolentry}
